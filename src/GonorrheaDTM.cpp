...
struct parameters {
  ...
  vector<vector<vector<vector<double>>>> newborneDistribution;
  vector<double> transmissionRate;
  vector<double> latencyRate;
  vector<double> propAsymp;
  vector<double> tretmentRate;
  vector<double> recoveryRate;
  vector<vector<vector<double>>> screeningRate;
};
