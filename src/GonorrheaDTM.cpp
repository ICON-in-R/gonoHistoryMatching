...
// [[Rcpp::export]]
double sumVector(std::vector<std::vector<std::vector<std::vector<std::vector<std::vector<std::vector<double>>>>>>>& population,
                 int i_start, int i_end, int j_start, int j_end, int k_start, int k_end, int l_start, int l_end, int m_start,
                 int m_end, int d_start, int d_end, int t_start, int t_end) {
  double sum = 0;
